...
//     // Get screen dimensions and create responsive sizing
...
//     }
//     // Use percentage-based height instead of fixed
...
//     bool isTablet,
//   ) {
//     final double calculatedHeight = (buttonGridHeight - (4 * 16)) / 5;

//     if (isTablet) {
//       return calculatedHeight.clamp(80.0, 120.0);
//     } else if (isSmallScreen) {
//       return calculatedHeight.clamp(45.0, 65.0);
//     } else if (isLargeScreen) {
//       return calculatedHeight.clamp(60.0, 90.0);
//     } else {
//       return calculatedHeight.clamp(50.0, 80.0);
//     }
//   }
...
//     bool isEqual = false,
//   }) {
//     final double fontSize = isTablet ? 28.0 : (screenWidth < 350 ? 16.0 : 20.0);
...
//   // Include all your existing calculation methods here...
...
//     final double availableHeight = screenHeight - safeArea.top - safeArea.bottom;
//     final double headerHeight = _getResponsiveHeaderHeight(screenSize, isTablet);
//     final double displayHeight = _getResponsiveDisplayHeight(screenSize, isTablet, isLandscape);
//     final double bottomNavHeight = isTablet ? 120.0 : 100.0;
    
//     final double buttonGridHeight = availableHeight - headerHeight - displayHeight - bottomNavHeight;
//     final double buttonHeight = _getResponsiveButtonHeight(buttonGridHeight, isSmallScreen, isLargeScreen, isTablet);
...
//               children: [
//                 CommonHeader(title: "Calculator"),
//                 _buildResponsiveDisplay(screenSize, isSmallScreen, isLargeScreen, isTablet),
//                 Expanded(
//                   child: _buildResponsiveButtonGrid(
//                     buttonHeight, 
//                     screenWidth, 
...
//   double _getResponsiveDisplayHeight(Size screenSize, bool isTablet, bool isLandscape) {
//     if (isTablet) {
//       return isLandscape ? 120.0 : 200.0;
//     }
//     if (isLandscape) {
...
//   double _getResponsiveButtonHeight(double buttonGridHeight, bool isSmallScreen, bool isLargeScreen, bool isTablet) {
//     final double calculatedHeight = (buttonGridHeight - (5 * 16)) / 6; // 6 rows now (added voice row)
...
//   Widget _buildResponsiveDisplay(Size screenSize, bool isSmallScreen, bool isLargeScreen, bool isTablet) {
//     final double displayHeight = _getResponsiveDisplayHeight(screenSize, isTablet, false);
//     final double horizontalPadding = isTablet ? 32.0 : 16.0;
//     final double verticalPadding = isSmallScreen ? 6.0 : 8.0;
...
//                         ? (_isListening ? 'Listening for speech...' : 'Enter calculation or speak...')
//                         : 'Enter calculation...',
//                     hintStyle: TextStyle(
//                       color: AppColors.textWhite.withOpacity(0.3),
//                       fontSize: _getResponsiveInputFontSize(screenSize, isTablet) * 0.9,
//                     ),
//                   ),
//                   textAlign: TextAlign.right,
//                   keyboardType: TextInputType.none,
...
//                   style: TextStyle(
//                     color: AppColors.textWhite,
//                     fontSize: _getResponsiveResultFontSize(screenSize, isTablet, _isCalculated),
//                     fontWeight: _isCalculated ? FontWeight.bold : FontWeight.w500,
//                     fontStyle: _isCalculated ? FontStyle.normal : FontStyle.italic,
//                   ),
//                   child: FittedBox(
//                     fit: BoxFit.scaleDown,
//                     child: Text(
//                       _currentResult == '0' && calculation.isEmpty ? '0' : _currentResult,
//                       maxLines: 1,
//                     ),
//                   ),
//                 ),
...
//   double _getResponsiveResultFontSize(Size screenSize, bool isTablet, bool isCalculated) {
//     final double baseFontSize = isTablet ? 48.0 : 32.0;
//     final double previewSize = isTablet ? 24.0 : 18.0;
...
//     final double horizontalPadding = isTablet ? 32.0 : 16.0;
//     final double verticalPadding = isLandscape ? 4.0 : 8.0;
//     final double buttonSpacing = isTablet ? 20.0 : (isSmallScreen ? 12.0 : 16.0);
...
//           // Row 1: C, ⌫, %, ÷
//           _buildResponsiveButtonRow([
//             _buildResponsiveButton(AppStrings.clear, AppColors.textPurple, _clearAll, buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton("⌫", AppColors.textPurple, _backspace, buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.percent, AppColors.textPurple, () => _appendToInput('%'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.divide, AppColors.primaryColor, () => _appendToInput('÷'), buttonHeight, screenWidth, isTablet),
//           ], buttonSpacing),
          
//           // Row 2: 7, 8, 9, ×
//           _buildResponsiveButtonRow([
//             _buildResponsiveButton(AppStrings.seven, AppColors.textWhite, () => _appendToInput('7'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.eight, AppColors.textWhite, () => _appendToInput('8'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.nine, AppColors.textWhite, () => _appendToInput('9'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.multiply, AppColors.primaryColor, () => _appendToInput('×'), buttonHeight, screenWidth, isTablet),
//           ], buttonSpacing),
          
//           // Row 3: 4, 5, 6, −
//           _buildResponsiveButtonRow([
//             _buildResponsiveButton(AppStrings.four, AppColors.textWhite, () => _appendToInput('4'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.five, AppColors.textWhite, () => _appendToInput('5'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.six, AppColors.textWhite, () => _appendToInput('6'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.subtract, AppColors.primaryColor, () => _appendToInput('−'), buttonHeight, screenWidth, isTablet),
//           ], buttonSpacing),
          
//           // Row 4: 1, 2, 3, +
//           _buildResponsiveButtonRow([
//             _buildResponsiveButton(AppStrings.one, AppColors.textWhite, () => _appendToInput('1'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.two, AppColors.textWhite, () => _appendToInput('2'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.three, AppColors.textWhite, () => _appendToInput('3'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.add, AppColors.primaryColor, () => _appendToInput('+'), buttonHeight, screenWidth, isTablet),
//           ], buttonSpacing),
          
//           // Row 5: 0, ., =
//           _buildResponsiveButtonRow([
//             _buildResponsiveWideButton(AppStrings.zero, AppColors.textWhite, () => _appendToInput('0'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.decimal, AppColors.textWhite, () => _appendToInput('.'), buttonHeight, screenWidth, isTablet),
//             _buildResponsiveButton(AppStrings.equals, AppColors.textWhite, _calculate, buttonHeight, screenWidth, isTablet, isEqual: true),
//           ], buttonSpacing),
...
//   Widget _buildVoiceButton(double buttonHeight, double screenWidth, bool isTablet) {
//     return Expanded(
...
//                   : _speechEnabled 
//                     ? [AppColors.primaryColor.withOpacity(0.8), AppColors.textPurple.withOpacity(0.8)]
...
//     return Expanded(
//       child: Row(
//         children: buttons.expand((widget) => [widget, SizedBox(width: spacing)]).take(buttons.length * 2 - 1).toList(),
//       ),
//     );
//   }
...
//             ),
//             const SizedBox(height: 20),
//             ...SpeechService().getExampleCommands().map((command) => Padding(
...
//         _historyService.addCalculation(_inputController.text, _currentResult, 'Calculator');
//         HapticFeedback.mediumImpact();
...
//         for (int i = 1; i < expression.length; i++) {
//           if (expression[i] == op && 
//               (op != '-' || (i > 0 && '0123456789)'.contains(expression[i-1])))) {
//             opIndex = i;
//             break;
//           }
//         }
...
class _CalculatorScreenState extends State<CalculatorScreen> with TickerProviderStateMixin {
  ...
  bool _voiceAutoCalculated = false;
    ...
    await _speechService.startListening(
      onResult: (recognizedText, shouldAutoCalculate) {
        if (recognizedText.isNotEmpty) {
          setState(() {
            _speechText = recognizedText;
            _lastVoiceInput = recognizedText;
            _inputController.text = recognizedText;
            calculation = recognizedText;
            _isCalculated = false;
          });
          ...
          // Auto-calculate complete expressions
          if (shouldAutoCalculate && !_voiceAutoCalculated) {
            _voiceAutoCalculated = true;
            // Small delay for better UX
            Future.delayed(const Duration(milliseconds: 800), () {
              if (mounted && _lastVoiceInput == recognizedText) {
                _calculate();
                _stopListening();
              }
            });
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            const SizedBox(width: 8),
            const Text('Voice input timed out'),
          ],
        ),
        backgroundColor: Colors.orange,
        behavior: SnackBarBehavior.floating,
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Speak naturally - calculations happen automatically!',
              style: TextStyle(
            ...
            // Basic Operations
            _buildHelpSection('Basic Operations', [
              '"Five plus three"',
              '"Twenty minus eight"', 
              '"Six times seven"',
            ...
            // Alternative Phrases
            _buildHelpSection('Alternative Phrases', [
            ...
            // Natural Language
            _buildHelpSection('Natural Language', [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    '• Complete expressions calculate automatically\n'
                    '• Voice stops after 3 seconds of silence\n'
                    '• Maximum listening time: 15 seconds\n'
                    '• Long press voice button for this help',
                    style: TextStyle(
    ...
    return Column(
      ...
      children: [
        ...
        ...examples.map((example) => Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.mic, color: AppColors.primaryColor, size: 14),
              const SizedBox(width: 8),
              Text(
                example,
